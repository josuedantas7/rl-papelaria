...
const BannerHome = () => {
  ...
  return (
      <div className='relative'>
        <Image className='object-contain mx-auto h-[400px] mt-2.5' priority={true} src={logo} alt='logo loja'/>
        <button onClick={() => redirectLink()} className='absolute bottom-12 left-0 right-0 flex gap-2 items-center justify-center'>
            <h1 className='text-xl'>Endereço:</h1>
            <p className='font-normal'>Rua E, 24 - Nova Marabá, Marabá - PA, 68504-040</p>
        </button>
